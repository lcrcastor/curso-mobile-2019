...
class DefaultCachedSettingsIo implements CachedSettingsIo {
    ...
    public JSONObject readCachedSettings() {
        ...
        try {
            File file = new File(new FileStoreImpl(this.a).getFilesDir(), Settings.SETTINGS_CACHE_FILENAME);
            if (file.exists()) {
    ...
    public void writeCachedSettings(long j, JSONObject jSONObject) {
        ...
        if (jSONObject != null) {
            ...
            try {
                ...
                FileWriter fileWriter2 = new FileWriter(new File(new FileStoreImpl(this.a).getFilesDir(), Settings.SETTINGS_CACHE_FILENAME));
                try {
