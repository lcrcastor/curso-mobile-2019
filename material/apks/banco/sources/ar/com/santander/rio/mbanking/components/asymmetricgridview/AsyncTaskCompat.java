...
public abstract class AsyncTaskCompat<Params, Progress, Result> {
    ...
    private final WorkerRunnable<Params, Result> h = new WorkerRunnable<Params, Result>() {
        public Result call() {
            ...
            return AsyncTaskCompat.this.b(AsyncTaskCompat.this.doInBackground(this.b));
        }
    };
    ...
    static class AsyncTaskResult<Data> {
        ...
        AsyncTaskResult(AsyncTaskCompat asyncTaskCompat, Data... dataArr) {
