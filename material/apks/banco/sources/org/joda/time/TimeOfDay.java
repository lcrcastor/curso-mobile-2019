...
public final class TimeOfDay extends BasePartial implements Serializable, ReadablePartial {
    ...
    private static final DateTimeFieldType[] a = {DateTimeFieldType.hourOfDay(), DateTimeFieldType.minuteOfHour(), DateTimeFieldType.secondOfMinute(), DateTimeFieldType.millisOfSecond()};
    ...
    public static class Property extends AbstractPartialFieldProperty implements Serializable {
        ...
        public TimeOfDay addToCopy(int i) {
            return new TimeOfDay(this.a, getField().addWrapPartial(this.a, this.b, this.a.getValues(), i));
        }

        public TimeOfDay addNoWrapToCopy(int i) {
            return new TimeOfDay(this.a, getField().add(this.a, this.b, this.a.getValues(), i));
        }

        public TimeOfDay addWrapFieldToCopy(int i) {
            return new TimeOfDay(this.a, getField().addWrapField(this.a, this.b, this.a.getValues(), i));
        }

        public TimeOfDay setCopy(int i) {
            return new TimeOfDay(this.a, getField().set(this.a, this.b, this.a.getValues(), i));
        }

        public TimeOfDay setCopy(String str, Locale locale) {
            return new TimeOfDay(this.a, getField().set(this.a, this.b, this.a.getValues(), str, locale));
        }
