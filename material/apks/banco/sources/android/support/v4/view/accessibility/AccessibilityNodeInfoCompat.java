...
public class AccessibilityNodeInfoCompat {
    ...
    public static class RangeInfoCompat {
        ...
        public float getCurrent() {
            return VERSION.SDK_INT >= 19 ? ((RangeInfo) this.a).getCurrent() : BitmapDescriptorFactory.HUE_RED;
        }

        public float getMax() {
            return VERSION.SDK_INT >= 19 ? ((RangeInfo) this.a).getMax() : BitmapDescriptorFactory.HUE_RED;
        }

        public float getMin() {
            return VERSION.SDK_INT >= 19 ? ((RangeInfo) this.a).getMin() : BitmapDescriptorFactory.HUE_RED;
        }
    ...
    public static AccessibilityNodeInfoCompat obtain(View view, int i) {
        if (VERSION.SDK_INT >= 16) {
            return a((Object) AccessibilityNodeInfo.obtain(view, i));
        }
        return null;
    }
    ...
    public AccessibilityNodeInfoCompat findFocus(int i) {
        if (VERSION.SDK_INT >= 16) {
            return a((Object) this.a.findFocus(i));
        }
        return null;
    }
    ...
    public AccessibilityNodeInfoCompat focusSearch(int i) {
        if (VERSION.SDK_INT >= 16) {
            return a((Object) this.a.focusSearch(i));
        }
        return null;
    }
    ...
    public AccessibilityNodeInfoCompat getChild(int i) {
        return a((Object) this.a.getChild(i));
    }
    ...
    public List<AccessibilityActionCompat> getActionList() {
        List actionList = VERSION.SDK_INT >= 21 ? this.a.getActionList() : null;
        if (actionList == null) {
    ...
    public AccessibilityWindowInfoCompat getWindow() {
        if (VERSION.SDK_INT >= 21) {
            return AccessibilityWindowInfoCompat.a((Object) this.a.getWindow());
        }
        return null;
    }
