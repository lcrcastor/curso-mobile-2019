...
public abstract class Nat {
    ...
    public static int add33At(int i, int i2, int[] iArr, int i3) {
        ...
        iArr[i4] = (int) j;
        int i5 = i3 + 1;
        long j2 = (j >>> 32) + (((long) iArr[i5]) & 4294967295L) + 1;
        iArr[i5] = (int) j2;
        if ((j2 >>> 32) == 0) {
            return 0;
        }
    ...
    public static int add33At(int i, int i2, int[] iArr, int i3, int i4) {
        ...
        iArr[i5] = (int) j;
        int i6 = i5 + 1;
        long j2 = (j >>> 32) + (((long) iArr[i6]) & 4294967295L) + 1;
        iArr[i6] = (int) j2;
        if ((j2 >>> 32) == 0) {
            return 0;
        }
    ...
    public static int addBothTo(int i, int[] iArr, int i2, int[] iArr2, int i3, int[] iArr3, int i4) {
        ...
        while (i5 < i6) {
            int i7 = i4 + i5;
            long j2 = j + (((long) iArr[i2 + i5]) & 4294967295L) + (((long) iArr2[i3 + i5]) & 4294967295L) + (((long) iArr3[i7]) & 4294967295L);
            iArr3[i7] = (int) j2;
            j = j2 >>> 32;
            i5++;
            i6 = i;
    ...
    public static int addDWordAt(int i, long j, int[] iArr, int i2) {
        ...
        iArr[i3] = (int) j2;
        int i4 = i2 + 1;
        long j3 = (j2 >>> 32) + (((long) iArr[i4]) & 4294967295L) + (j >>> 32);
        iArr[i4] = (int) j3;
        if ((j3 >>> 32) == 0) {
            return 0;
        }
    ...
    public static int addDWordAt(int i, long j, int[] iArr, int i2, int i3) {
        ...
        int i4 = i2;
        int i5 = i4 + i3;
        long j2 = (((long) iArr2[i5]) & 4294967295L) + (j & 4294967295L);
        iArr2[i5] = (int) j2;
        int i6 = i5 + 1;
        long j3 = (j2 >>> 32) + (((long) iArr2[i6]) & 4294967295L) + (j >>> 32);
        iArr2[i6] = (int) j3;
        if ((j3 >>> 32) == 0) {
            return 0;
        }
        return incAt(i, iArr2, i4, i3 + 2);
    }

    public static int addDWordTo(int i, long j, int[] iArr) {
        long j2 = (((long) iArr[0]) & 4294967295L) + (j & 4294967295L);
        iArr[0] = (int) j2;
        long j3 = (j2 >>> 32) + (((long) iArr[1]) & 4294967295L) + (j >>> 32);
        iArr[1] = (int) j3;
        if ((j3 >>> 32) == 0) {
            return 0;
        }
    ...
    public static int addWordAt(int i, int i2, int[] iArr, int i3, int i4) {
        int i5 = i3 + i4;
        long j = (((long) i2) & 4294967295L) + (((long) iArr[i5]) & 4294967295L);
        iArr[i5] = (int) j;
        if ((j >>> 32) == 0) {
            return 0;
        }
    ...
    public static int mul31BothAdd(int i, int i2, int[] iArr, int i3, int[] iArr2, int[] iArr3, int i4) {
        ...
        while (true) {
            ...
            int i6 = i4 + i5;
            long j5 = j2;
            long j6 = j3 + ((((long) iArr[i5]) & 4294967295L) * j) + ((((long) iArr2[i5]) & 4294967295L) * j2) + (((long) iArr3[i6]) & 4294967295L);
            iArr3[i6] = (int) j6;
            j3 = j6 >>> 32;
            i5++;
            if (i5 >= i) {
    ...
    public static int mulAddTo(int i, int[] iArr, int i2, int[] iArr2, int i3, int[] iArr3, int i4) {
        ...
        for (int i7 = 0; i7 < i5; i7++) {
            int i8 = i6 + i5;
            long mulWordAddTo = (((long) mulWordAddTo(i5, iArr[i2 + i7], iArr2, i3, iArr3, i6)) & 4294967295L) + j + (((long) iArr3[i8]) & 4294967295L);
    ...
    public static int mulAddTo(int i, int[] iArr, int[] iArr2, int[] iArr3) {
        ...
        for (int i3 = 0; i3 < i2; i3++) {
            long mulWordAddTo = ((long) mulWordAddTo(i2, iArr[i3], iArr2, 0, iArr3, i3)) & 4294967295L;
            int i4 = i3 + i2;
            long j2 = mulWordAddTo + j + (((long) iArr3[i4]) & 4294967295L);
            iArr3[i4] = (int) j2;
            j = j2 >>> 32;
        }
        return (int) j;
    ...
    public static int mulWordAddTo(int i, int i2, int[] iArr, int i3, int[] iArr2, int i4) {
        ...
        while (true) {
            int i6 = i4 + i5;
            long j3 = j;
            long j4 = j2 + ((((long) iArr[i3 + i5]) & 4294967295L) * j) + (((long) iArr2[i6]) & 4294967295L);
            iArr2[i6] = (int) j4;
            j2 = j4 >>> 32;
            i5++;
            if (i5 >= i) {
    ...
    public static void square(int i, int[] iArr, int i2, int[] iArr2, int i3) {
        ...
        do {
            i6--;
            long j = ((long) iArr[i2 + i6]) & 4294967295L;
            long j2 = j * j;
            int i9 = i7 - 1;
            iArr2[i3 + i9] = (i8 << 31) | ((int) (j2 >>> 33));
            i7 = i9 - 1;
    ...
    public static int squareWordAdd(int[] iArr, int i, int[] iArr2) {
        ...
        do {
            int i4 = i2 + i3;
            long j3 = j2 + ((((long) iArr[i3]) & 4294967295L) * j) + (((long) iArr2[i4]) & 4294967295L);
            iArr2[i4] = (int) j3;
            j2 = j3 >>> 32;
            i3++;
        } while (i3 < i2);
    ...
    public static int sub(int i, int[] iArr, int i2, int[] iArr2, int i3, int[] iArr3, int i4) {
        ...
        for (int i6 = 0; i6 < i5; i6++) {
            long j2 = j + ((((long) iArr[i2 + i6]) & 4294967295L) - (((long) iArr2[i3 + i6]) & 4294967295L));
            iArr3[i4 + i6] = (int) j2;
            j = j2 >> 32;
        }
        return (int) j;
    ...
    public static int subBothFrom(int i, int[] iArr, int i2, int[] iArr2, int i3, int[] iArr3, int i4) {
        ...
        while (i5 < i6) {
            int i7 = i4 + i5;
            long j2 = j + (((((long) iArr3[i7]) & 4294967295L) - (((long) iArr[i2 + i5]) & 4294967295L)) - (((long) iArr2[i3 + i5]) & 4294967295L));
            iArr3[i7] = (int) j2;
            j = j2 >> 32;
            i5++;
            i6 = i;
    ...
    public static int subBothFrom(int i, int[] iArr, int[] iArr2, int[] iArr3) {
        long j = 0;
        for (int i2 = 0; i2 < i; i2++) {
            long j2 = j + (((((long) iArr3[i2]) & 4294967295L) - (((long) iArr[i2]) & 4294967295L)) - (((long) iArr2[i2]) & 4294967295L));
            iArr3[i2] = (int) j2;
            j = j2 >> 32;
        }
        return (int) j;
    ...
    public static int subFrom(int i, int[] iArr, int i2, int[] iArr2, int i3) {
        ...
        for (int i5 = 0; i5 < i4; i5++) {
            int i6 = i3 + i5;
            long j2 = j + ((((long) iArr2[i6]) & 4294967295L) - (((long) iArr[i2 + i5]) & 4294967295L));
            iArr2[i6] = (int) j2;
            j = j2 >> 32;
        }
        return (int) j;
