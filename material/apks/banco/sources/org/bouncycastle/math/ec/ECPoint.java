...
public abstract class ECPoint {
    ...
    public static class F2m extends AbstractF2m {
        ...
        public F2m addSimple(F2m f2m) {
            ...
            ECFieldElement eCFieldElement8 = f2m.x;
            if (coordinateSystem != 6) {
                switch (coordinateSystem) {
                    case 0:
                        ECFieldElement eCFieldElement9 = this.y;
                        ECFieldElement eCFieldElement10 = f2m.y;
                    ...
                    case 1:
                        ...
                        ECFieldElement eCFieldElement13 = f2m.y;
                        ECFieldElement eCFieldElement14 = f2m.zs[0];
                        ...
                        if (add5.isZero()) {
                            return add4.isZero() ? (F2m) twice() : (F2m) curve.getInfinity();
                        }
                        ...
                        F2m f2m2 = new F2m(curve, multiply2, add4.multiplyPlusProduct(eCFieldElement7, add5, eCFieldElement11).multiplyPlusProduct(square, add6, add7), new ECFieldElement[]{multiply.multiply(eCFieldElement12)}, this.withCompression);
                        return f2m2;
                    default:
                        throw new IllegalStateException("unsupported coordinate system");
                }
            } else if (eCFieldElement7.isZero()) {
                return eCFieldElement8.isZero() ? (F2m) curve.getInfinity() : f2m.addSimple(this);
            } else {
                ECFieldElement eCFieldElement15 = this.y;
                ECFieldElement eCFieldElement16 = this.zs[0];
                ECFieldElement eCFieldElement17 = f2m.y;
                ECFieldElement eCFieldElement18 = f2m.zs[0];
                ...
                if (add9.isZero()) {
                    return add8.isZero() ? (F2m) twice() : (F2m) curve.getInfinity();
                }
                ...
                F2m f2m3 = new F2m(curve, eCFieldElement6, eCFieldElement5, new ECFieldElement[]{eCFieldElement4}, this.withCompression);
                return f2m3;
            }
        }
    ...
    public static class Fp extends AbstractFp {
        ...
        public ECPoint add(ECPoint eCPoint) {
            ...
            ECFieldElement eCFieldElement6 = this.y;
            ECFieldElement eCFieldElement7 = eCPoint2.x;
            ECFieldElement eCFieldElement8 = eCPoint2.y;
            if (coordinateSystem != 4) {
                switch (coordinateSystem) {
                    ...
                    case 1:
                        ...
                        ECFieldElement eCFieldElement10 = eCPoint2.zs[0];
                        ...
                        Fp fp = new Fp(curve, subtract5.multiply(subtract6), multiply2.subtract(subtract6).multiplyMinusProduct(subtract4, eCFieldElement6, multiply), new ECFieldElement[]{multiply.multiply(eCFieldElement9)}, this.withCompression);
                        return fp;
                    case 2:
                        break;
                    default:
            ...
            ECFieldElement eCFieldElement12 = eCPoint2.zs[0];
            ...
            if (isOne3 || !eCFieldElement11.equals(eCFieldElement12)) {
                ...
                eCFieldElement4 = eCFieldElement5.subtract(eCFieldElement7);
                ...
                if (isOne3) {
                    ...
                    eCFieldElement4 = eCFieldElement4.multiply(eCFieldElement11);
                    eCFieldElement = null;
                }
                eCFieldElement2 = subtract12;
                eCFieldElement3 = subtract11;
            }
            Fp fp2 = new Fp(curve, eCFieldElement3, eCFieldElement2, coordinateSystem == 4 ? new ECFieldElement[]{eCFieldElement4, calculateJacobianModifiedW(eCFieldElement4, eCFieldElement)} : new ECFieldElement[]{eCFieldElement4}, this.withCompression);
            return fp2;
        }
            ...
            switch (coordinateSystem) {
                ...
                case 2:
                    ...
                    if (negate.toBigInteger().equals(BigInteger.valueOf(3))) {
                        ...
                        if (!isOne2) {
                            if (!a2.isZero()) {
                                ECFieldElement square5 = (isOne2 ? eCFieldElement5 : eCFieldElement5.square()).square();
