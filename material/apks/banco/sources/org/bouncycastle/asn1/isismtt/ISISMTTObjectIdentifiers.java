...
public interface ISISMTTObjectIdentifiers {
    ...
    public static final ASN1ObjectIdentifier id_isismtt_at_certInDirSince = id_isismtt_at.branch(TipoCuentaDestino.CAJA_AHORRO_DOLARES);
    ...
    public static final ASN1ObjectIdentifier id_isismtt_at_namingAuthorities = id_isismtt_at.branch(TipoCuentaDestino.CAJA_AHORRO_PESOS);
