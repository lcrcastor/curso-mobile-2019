...
public class PromocionesFragment extends BaseFragment {
    ...
    class MyBrowser extends WebViewClient {
        ...
        public void onReceivedError(WebView webView, WebResourceRequest webResourceRequest, WebResourceError webResourceError) {
            if (VERSION.SDK_INT < 23 || webResourceError.getErrorCode() != -9) {
                if ((VERSION.SDK_INT < 21 || webResourceRequest.getUrl().toString().equals("https://santander.com.ar/banco/contenthandler/!ut/p/digest!BMpM8gh5LPWrILmlbdr1bg/dav/fs-type1/themes/SRP9Theme/images/favicon/favicon-228.png")) && PromocionesFragment.this.ad.isVisible() && PromocionesFragment.this.f.getVisibility() != 0) {
                    PromocionesFragment.this.C();
                    PromocionesFragment.this.D();
                }
            }
        }
    }
            ...
            if (this.g.isProviderEnabled("network") || this.g.isProviderEnabled("gps")) {
                ...
                newInstance.setDialogListener(new IDialogListener() {
                    ...
                    public void onPositiveButton() {
                        PromocionesFragment.this.startActivityForResult(new Intent("android.settings.LOCATION_SOURCE_SETTINGS"), 12333);
                    }

                    public void onNegativeButton() {
                        PromocionesFragment.this.e.loadUrl(PromocionesFragment.this.d);
                    }

                    public void onSimpleActionButton() {
                        ((SantanderRioMainActivity) PromocionesFragment.this.getActivity()).finish();
                    }
                });
    ...
    public View onCreateView(@NonNull LayoutInflater layoutInflater, @Nullable ViewGroup viewGroup, @Nullable Bundle bundle) {
        View inflate = layoutInflater.inflate(R.layout.fragment_map_promociones, viewGroup, false);
        this.b.trackScreen(getString(R.string.analytics_screen_name_promociones_home));
        this.e = (WebView) inflate.findViewById(R.id.wvPromociones);
        this.d = this.c.loadStringObject(SettingsManager.PROMOCIONES_URL_HOME);
    ...
    public void onCheckVersion(final CheckVersionEvent checkVersionEvent) {
        ...
        if (this.ae.getCheckVersionManager().isUpdateAvailable()) {
            this.ae.getCheckVersionManager().check(checkVersionEvent, new IDialogListener() {
                ...
                public void onPositiveButton() {
                    Intent intent = new Intent("android.intent.action.VIEW", Uri.parse(PromocionesFragment.this.ae.getCheckVersionManager().getUpdateBean(checkVersionEvent).getUrl()));
                    intent.setFlags(268435456);
                    PromocionesFragment.this.ae.getApplicationContext().startActivity(intent);
                    PromocionesFragment.this.ae.setResult(-1);
                    PromocionesFragment.this.ae.finish();
                }
                ...
                public void onNegativeButton() {
                    if (result.equals("3")) {
                        ...
                        PromocionesFragment.this.ae.getSessionManager().setCheckVersionWarningRaised(Boolean.valueOf(true));
                    }
                }
            });
            return;
