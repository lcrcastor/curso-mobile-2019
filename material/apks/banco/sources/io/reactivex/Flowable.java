...
public abstract class Flowable<T> implements Publisher<T> {
    ...
    public final <U extends Collection<? super T>> Flowable<U> buffer(long j, long j2, TimeUnit timeUnit, Scheduler scheduler, Callable<U> callable) {
        ...
        FlowableBufferTimed flowableBufferTimed = new FlowableBufferTimed(this, j, j2, timeUnit2, scheduler2, callable2, SubsamplingScaleImageView.TILE_SIZE_AUTO, false);
    ...
    public final Completable flatMapCompletable(Function<? super T, ? extends CompletableSource> function) {
        return flatMapCompletable(function, false, SubsamplingScaleImageView.TILE_SIZE_AUTO);
    }
    ...
    public final <R> Flowable<R> flatMapMaybe(Function<? super T, ? extends MaybeSource<? extends R>> function) {
        return flatMapMaybe(function, false, SubsamplingScaleImageView.TILE_SIZE_AUTO);
    }
    ...
    public final <R> Flowable<R> flatMapSingle(Function<? super T, ? extends SingleSource<? extends R>> function) {
        return flatMapSingle(function, false, SubsamplingScaleImageView.TILE_SIZE_AUTO);
    }
    ...
    public <R> Flowable<R> a(Function<? super T, ? extends Publisher<? extends R>> function, int i, boolean z) {
        ObjectHelper.requireNonNull(function, "mapper is null");
        ObjectHelper.verifyPositive(i, "bufferSize");
        if (!(this instanceof ScalarCallable)) {
    ...
    public final <V> Flowable<T> timeout(Function<? super T, ? extends Publisher<V>> function, Flowable<? extends T> flowable) {
        ...
        return a(null, function, (Publisher<? extends T>) flowable);
    }
    ...
    public final <U, V> Flowable<T> timeout(Publisher<U> publisher, Function<? super T, ? extends Publisher<V>> function) {
        ...
        return a(publisher, function, null);
    }
