...
public class BuyDollarsReceiptActivity extends BuySellDollarsReceiptActivity {
    ...
    public void onCreate(Bundle bundle) {
        ...
        this.p.trackScreen(getString(R.string.analytics_screen_comprobante_compra_dolares));
        this.s = this;
    }

    public void configureLayout() {
        this.activityTitle.setText(getString(R.string.ID3700_COMPRA_VENTA_LBL_COMPROBANTE_COMPRA));
        this.lbl_dollarsToOperate.setText(getString(R.string.ID3620_COMPRA_VENTA_LBL_DOLARES_ACREDITADOS));
        this.lbl_pesosToOperate.setText(getString(R.string.ID3625_COMPRA_VENTA_LBL_PESOS_DEBITADOS));
    }
    ...
    public void showSharedOption() {
        ...
        newInstance.setDialogListener(new IDialogListener() {
            ...
            public void onItemSelected(String str) {
                if (str.equalsIgnoreCase(BuyDollarsReceiptActivity.this.getResources().getString(R.string.IDXX_SHARE_OPTION_RECEIPT))) {
                    BuyDollarsReceiptActivity.this.sharingOptions.optionShareSelected();
                } else if (str.equalsIgnoreCase(BuyDollarsReceiptActivity.this.getResources().getString(R.string.IDXX_SHARE_OPTION_RECEIPT_DOWNLOAD))) {
                    BuyDollarsReceiptActivity.this.sharingOptions.optionDownloadSelected();
                }
            }
        });
    ...
    public void configureOptionsShare() {
        this.sharingOptions = new OptionsToShareImpl(this, getApplicationContext(), getSupportFragmentManager()) {
            public View getViewToShare() {
                return BuyDollarsReceiptActivity.this.lnlReceipt;
            }

            public void receiveIntentAppShare(Intent intent) {
                BuyDollarsReceiptActivity.this.startActivityForResult(Intent.createChooser(intent, BuyDollarsReceiptActivity.this.getString(R.string.IDXX_SHARE_OPTION_RECEIPT)), 3);
            }

            public String getFileName() {
                return String.format(BuyDollarsReceiptActivity.this.getString(R.string.IDXX_COMPRA_DOLARES_ARCHIVO_JPG_COMPROBANTE), new Object[]{BuyDollarsReceiptActivity.this.mReceiptNbr});
            }

            public String getSubjectReceiptToShare() {
                return String.format(BuyDollarsReceiptActivity.this.getString(R.string.IDXX_COMPRA_DOLARES_ASUNTO_MAIL), new Object[]{BuyDollarsReceiptActivity.this.mReceiptNbr});
            }

            public void optionDownloadSelected() {
                super.optionDownloadSelected();
                BuyDollarsReceiptActivity.this.receiptHasBeenDownloaded = Boolean.valueOf(true);
            }
            ...
            public void onAbortShare() {
                super.onAbortShare();
                BuyDollarsReceiptActivity.this.receiptHasBeenDownloaded = Boolean.valueOf(true);
                BuyDollarsReceiptActivity.this.onBackPressed();
            }
        };
    }
    ...
    public void configureOptionsShare(int i) {
        ...
        AnonymousClass3 r0 = new OptionsToShareImpl(this, getApplicationContext(), getSupportFragmentManager()) {
            ...
            public void onAbortShare() {
                super.onAbortShare();
                BuyDollarsReceiptActivity.this.receiptHasBeenDownloaded = Boolean.valueOf(true);
                BuyDollarsReceiptActivity.this.onClickItem(i2);
            }
        };
