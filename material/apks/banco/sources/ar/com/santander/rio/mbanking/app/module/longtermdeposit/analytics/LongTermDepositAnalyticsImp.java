...
public class LongTermDepositAnalyticsImp implements LongTermDepositAnalytics {
    private Context a;
    private AnalyticsManager b;

    public LongTermDepositAnalyticsImp(Context context, AnalyticsManager analyticsManager) {
        this.a = context;
    ...
    public void registerScreenErrorParcial() {
        this.b.trackScreen(this.a.getString(R.string.analytics_tenencia_inversiones_screean_name_plazo_fijo_error_parcial));
    }

    public void registerScreeErrorTotal() {
        this.b.trackScreen(this.a.getString(R.string.analytics_tenencia_inversiones_screean_name_plazo_fijo_error_total));
    }
}
