...
public abstract class GetTurnoRequest extends BaseRequest implements IBeanRequestWS {
    private GetTurnoRequestBean mGetTurnoRequestBean;
    private GetTurnoResponseBean mGetTurnoResponseBean;

    public int getMethod() {
        return 1;
    }

    public GetTurnoRequest(Context context, GetTurnoRequestBean getTurnoRequestBean, ErrorRequestServer errorRequestServer) {
        super(context);
        this.mGetTurnoRequestBean = getTurnoRequestBean;
        this.mErrorRequestServer = errorRequestServer;
    }

    public GetTurnoRequest(ErrorRequestServer errorRequestServer) {
        this.mErrorRequestServer = errorRequestServer;
    }
    ...
    public IBeanWS getBeanToRequest() {
        return this.mGetTurnoRequestBean;
    }

    public Class getBeanResponseClass() {
        if (this.mGetTurnoResponseBean == null) {
            this.mGetTurnoResponseBean = new GetTurnoResponseBean();
        }
        return this.mGetTurnoResponseBean.getClass();
    }
    ...
    public boolean parserResponse(com.indra.httpclient.json.JSONObject r8) {
        /*
            ...
            com.indra.httpclient.json.JSONObject r2 = r2.getJSONObject(r3)     // Catch:{ JSONException -> 0x00a4 }
            ar.com.santander.rio.mbanking.services.soap.beans.body.GetTurnoResponseBean r3 = new ar.com.santander.rio.mbanking.services.soap.beans.body.GetTurnoResponseBean     // Catch:{ JSONException -> 0x00a4 }
            ...
            ar.com.santander.rio.mbanking.services.soap.beans.body.GetTurnoBodyResponseBean r4 = new ar.com.santander.rio.mbanking.services.soap.beans.body.GetTurnoBodyResponseBean     // Catch:{ JSONException -> 0x00a4 }
        ...
        L_0x008a:
            ...
            java.lang.Class<ar.com.santander.rio.mbanking.services.soap.beans.body.GetTurnoBodyResponseBean> r4 = ar.com.santander.rio.mbanking.services.soap.beans.body.GetTurnoBodyResponseBean.class
            java.lang.Object r8 = r8.fromJson(r2, r4)     // Catch:{ JSONException -> 0x00a4 }
            ar.com.santander.rio.mbanking.services.soap.beans.body.GetTurnoBodyResponseBean r8 = (ar.com.santander.rio.mbanking.services.soap.beans.body.GetTurnoBodyResponseBean) r8     // Catch:{ JSONException -> 0x00a4 }
            r3.setGetTurnoBodyResponseBean(r8)     // Catch:{ JSONException -> 0x00a4 }
        ...
        L_0x00a8:
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: ar.com.santander.rio.mbanking.services.soap.beans.body.GetTurnoRequest.parserResponse(com.indra.httpclient.json.JSONObject):boolean");
    }
}
