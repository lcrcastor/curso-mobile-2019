...
public class FontResourcesParserCompat {
    ...
    @Nullable
    private static FamilyResourceEntry a(XmlPullParser xmlPullParser, Resources resources) {
    ...
    private static FontFileResourceEntry c(XmlPullParser xmlPullParser, Resources resources) {
        TypedArray obtainAttributes = resources.obtainAttributes(Xml.asAttributeSet(xmlPullParser), R.styleable.FontFamilyFont);
        int i = obtainAttributes.getInt(obtainAttributes.hasValue(R.styleable.FontFamilyFont_fontWeight) ? R.styleable.FontFamilyFont_fontWeight : R.styleable.FontFamilyFont_android_fontWeight, HttpStatus.SC_BAD_REQUEST);
        boolean z = true;
