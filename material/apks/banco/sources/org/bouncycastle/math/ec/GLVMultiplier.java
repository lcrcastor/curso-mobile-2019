...
public class GLVMultiplier extends AbstractECMultiplier {
    ...
    public ECPoint multiplyPositive(ECPoint eCPoint, BigInteger bigInteger) {
        ...
        return this.glvEndomorphism.hasEfficientPointMap() ? ECAlgorithms.a(eCPoint, bigInteger2, pointMap, bigInteger3) : ECAlgorithms.b(eCPoint, bigInteger2, pointMap.map(eCPoint), bigInteger3);
    }
}
