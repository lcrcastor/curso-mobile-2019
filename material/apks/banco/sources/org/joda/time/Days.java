...
public final class Days extends BaseSingleFieldPeriod {
    ...
    public static final Days MAX_VALUE = new Days(SubsamplingScaleImageView.TILE_SIZE_AUTO);
    ...
    private static final PeriodFormatter a = ISOPeriodFormat.standard().withParseType(PeriodType.days());
    ...
    public static Days parseDays(String str) {
        ...
        return days(a.parsePeriod(str).getDays());
    }
