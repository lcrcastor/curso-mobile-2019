...
public final class Weeks extends BaseSingleFieldPeriod {
    public static final Weeks MAX_VALUE = new Weeks(SubsamplingScaleImageView.TILE_SIZE_AUTO);
    public static final Weeks MIN_VALUE = new Weeks(Integer.MIN_VALUE);
    public static final Weeks ONE = new Weeks(1);
    public static final Weeks THREE = new Weeks(3);
    public static final Weeks TWO = new Weeks(2);
    public static final Weeks ZERO = new Weeks(0);
    private static final PeriodFormatter a = ISOPeriodFormat.standard().withParseType(PeriodType.weeks());
    ...
    public static Weeks parseWeeks(String str) {
        ...
        return weeks(a.parsePeriod(str).getWeeks());
    }
