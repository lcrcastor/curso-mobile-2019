...
public class EntityBuilder {
    ...
    public HttpEntity build() {
        ...
        if (this.a != null) {
            abstractHttpEntity = new StringEntity(this.a, a(ContentType.DEFAULT_TEXT));
        } else if (this.b != null) {
            abstractHttpEntity = new ByteArrayEntity(this.b, a(ContentType.DEFAULT_BINARY));
        } else if (this.c != null) {
            abstractHttpEntity = new InputStreamEntity(this.c, -1, a(ContentType.DEFAULT_BINARY));
        } else if (this.d != null) {
            abstractHttpEntity = new UrlEncodedFormEntity((Iterable<? extends NameValuePair>) this.d, this.g != null ? this.g.getCharset() : null);
        } else if (this.e != null) {
            abstractHttpEntity = new SerializableEntity(this.e);
            abstractHttpEntity.setContentType(ContentType.DEFAULT_BINARY.toString());
        } else if (this.f != null) {
            abstractHttpEntity = new FileEntity(this.f, a(ContentType.DEFAULT_BINARY));
        } else {
            abstractHttpEntity = new BasicHttpEntity();
        }
        if (!(abstractHttpEntity.getContentType() == null || this.g == null)) {
            abstractHttpEntity.setContentType(this.g.toString());
        }
        abstractHttpEntity.setContentEncoding(this.h);
        abstractHttpEntity.setChunked(this.i);
        return this.j ? new GzipCompressingEntity(abstractHttpEntity) : abstractHttpEntity;
    }
}
