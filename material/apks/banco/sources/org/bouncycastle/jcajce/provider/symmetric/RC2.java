...
public final class RC2 {
    ...
    public static class AlgParams extends BaseAlgorithmParameters {
        ...
        public byte[] engineGetEncoded(String str) {
            if (isASN1FormatString(str)) {
                return (this.d == -1 ? new RC2CBCParameter(engineGetEncoded()) : new RC2CBCParameter(this.d, engineGetEncoded())).getEncoded();
            ...
            if (algorithmParameterSpec instanceof IvParameterSpec) {
                ...
                if (effectiveKeyBits != -1) {
                    if (effectiveKeyBits < 256) {
                        effectiveKeyBits = a[effectiveKeyBits];
                    }
        ...
        public void engineInit(byte[] bArr, String str) {
            if (isASN1FormatString(str)) {
                ...
                if (instance.getRC2ParameterVersion() != null) {
                    this.d = instance.getRC2ParameterVersion().intValue();
                }
                this.c = instance.getIV();
            } else if (str.equals("RAW")) {
                engineInit(bArr);
            } else {
    ...
    public static class Mappings extends AlgorithmProvider {
        ...
        public void configure(ConfigurableProvider configurableProvider) {
            ...
            sb9.append(PKCSObjectIdentifiers.id_alg_CMSRC2wrap);
            configurableProvider.addAlgorithm(sb9.toString(), "RC2WRAP");
            StringBuilder sb10 = new StringBuilder();
            sb10.append(a);
            sb10.append("$CBC");
            configurableProvider.addAlgorithm("Cipher.1.2.840.113549.3.2", sb10.toString());
            StringBuilder sb11 = new StringBuilder();
            sb11.append(a);
            sb11.append("$CBCMAC");
            configurableProvider.addAlgorithm("Mac.RC2MAC", sb11.toString());
            configurableProvider.addAlgorithm("Alg.Alias.Mac.RC2", "RC2MAC");
            StringBuilder sb12 = new StringBuilder();
            sb12.append(a);
            sb12.append("$CFB8MAC");
            configurableProvider.addAlgorithm("Mac.RC2MAC/CFB8", sb12.toString());
            ...
            sb13.append("Alg.Alias.SecretKeyFactory.");
            sb13.append(PKCSObjectIdentifiers.pbeWithMD2AndRC2_CBC);
            configurableProvider.addAlgorithm(sb13.toString(), "PBEWITHMD2ANDRC2");
            StringBuilder sb14 = new StringBuilder();
            sb14.append("Alg.Alias.SecretKeyFactory.");
            sb14.append(PKCSObjectIdentifiers.pbeWithMD5AndRC2_CBC);
            configurableProvider.addAlgorithm(sb14.toString(), "PBEWITHMD5ANDRC2");
            StringBuilder sb15 = new StringBuilder();
            sb15.append("Alg.Alias.SecretKeyFactory.");
            sb15.append(PKCSObjectIdentifiers.pbeWithSHA1AndRC2_CBC);
            configurableProvider.addAlgorithm(sb15.toString(), "PBEWITHSHA1ANDRC2");
            ...
            sb16.append(a);
            sb16.append("$PBEWithMD2KeyFactory");
            configurableProvider.addAlgorithm("SecretKeyFactory.PBEWITHMD2ANDRC2", sb16.toString());
            StringBuilder sb17 = new StringBuilder();
            sb17.append(a);
            sb17.append("$PBEWithMD5KeyFactory");
            configurableProvider.addAlgorithm("SecretKeyFactory.PBEWITHMD5ANDRC2", sb17.toString());
            StringBuilder sb18 = new StringBuilder();
            sb18.append(a);
            sb18.append("$PBEWithSHA1KeyFactory");
            configurableProvider.addAlgorithm("SecretKeyFactory.PBEWITHSHA1ANDRC2", sb18.toString());
            StringBuilder sb19 = new StringBuilder();
            sb19.append(a);
            sb19.append("$PBEWithSHAAnd128BitKeyFactory");
            configurableProvider.addAlgorithm("SecretKeyFactory.PBEWITHSHAAND128BITRC2-CBC", sb19.toString());
            StringBuilder sb20 = new StringBuilder();
            sb20.append(a);
            sb20.append("$PBEWithSHAAnd40BitKeyFactory");
            configurableProvider.addAlgorithm("SecretKeyFactory.PBEWITHSHAAND40BITRC2-CBC", sb20.toString());
            StringBuilder sb21 = new StringBuilder();
            sb21.append("Alg.Alias.Cipher.");
            sb21.append(PKCSObjectIdentifiers.pbeWithMD2AndRC2_CBC);
            configurableProvider.addAlgorithm(sb21.toString(), "PBEWITHMD2ANDRC2");
            StringBuilder sb22 = new StringBuilder();
            sb22.append("Alg.Alias.Cipher.");
            sb22.append(PKCSObjectIdentifiers.pbeWithMD5AndRC2_CBC);
            configurableProvider.addAlgorithm(sb22.toString(), "PBEWITHMD5ANDRC2");
            StringBuilder sb23 = new StringBuilder();
            sb23.append("Alg.Alias.Cipher.");
            sb23.append(PKCSObjectIdentifiers.pbeWithSHA1AndRC2_CBC);
            configurableProvider.addAlgorithm(sb23.toString(), "PBEWITHSHA1ANDRC2");
            ...
            sb24.append(a);
            sb24.append("$PBEWithSHA1AndRC2");
            configurableProvider.addAlgorithm("Cipher.PBEWITHSHA1ANDRC2", sb24.toString());
            StringBuilder sb25 = new StringBuilder();
            sb25.append(a);
            sb25.append("$PBEWithSHAAnd128BitRC2");
            configurableProvider.addAlgorithm("Cipher.PBEWITHSHAAND128BITRC2-CBC", sb25.toString());
            StringBuilder sb26 = new StringBuilder();
            sb26.append(a);
            sb26.append("$PBEWithSHAAnd40BitRC2");
            configurableProvider.addAlgorithm("Cipher.PBEWITHSHAAND40BITRC2-CBC", sb26.toString());
            StringBuilder sb27 = new StringBuilder();
            sb27.append(a);
            sb27.append("$PBEWithMD5AndRC2");
            configurableProvider.addAlgorithm("Cipher.PBEWITHMD5ANDRC2", sb27.toString());
