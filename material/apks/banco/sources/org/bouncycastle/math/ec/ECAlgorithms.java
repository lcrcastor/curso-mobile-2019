...
public class ECAlgorithms {
    ...
    static ECPoint a(ECPoint[] eCPointArr, BigInteger[] bigIntegerArr, GLVEndomorphism gLVEndomorphism) {
        ...
        if (gLVEndomorphism.hasEfficientPointMap()) {
            return a(eCPointArr, pointMap, bigIntegerArr2);
        }
    ...
    static ECPoint b(ECPoint eCPoint, BigInteger bigInteger, ECPoint eCPoint2, BigInteger bigInteger2) {
        ...
        return a(z2 ? precompute.getPreCompNeg() : precompute.getPreComp(), z2 ? precompute.getPreComp() : precompute.getPreCompNeg(), WNafUtil.generateWindowNaf(max, abs), z ? precompute2.getPreCompNeg() : precompute2.getPreComp(), z ? precompute2.getPreComp() : precompute2.getPreCompNeg(), WNafUtil.generateWindowNaf(max2, abs2));
    }
    ...
    public static ECPoint shamirsTrick(ECPoint eCPoint, BigInteger bigInteger, ECPoint eCPoint2, BigInteger bigInteger2) {
        return validatePoint(a(eCPoint, bigInteger, importPoint(eCPoint.getCurve(), eCPoint2), bigInteger2));
    }
            ...
            if (eCPointArr.length >= 1) {
                ...
                switch (length) {
                    ...
                    default:
                        ...
                        return endomorphism instanceof GLVEndomorphism ? validatePoint(a(eCPointArr2, bigIntegerArr, (GLVEndomorphism) endomorphism)) : validatePoint(a(eCPointArr2, bigIntegerArr));
                }
            }
        }
    ...
    public static ECPoint sumOfTwoMultiplies(ECPoint eCPoint, BigInteger bigInteger, ECPoint eCPoint2, BigInteger bigInteger2) {
        ...
        if (!(curve instanceof F2m) || !((F2m) curve).isKoblitz()) {
            ...
            if (endomorphism instanceof GLVEndomorphism) {
                b = a(new ECPoint[]{eCPoint, importPoint}, new BigInteger[]{bigInteger, bigInteger2}, (GLVEndomorphism) endomorphism);
            } else {
                b = b(eCPoint, bigInteger, importPoint, bigInteger2);
            }
        } else {
            b = eCPoint.multiply(bigInteger).add(importPoint.multiply(bigInteger2));
        }
        return validatePoint(b);
    }
