...
public class DateUtils {
    ...
    private static long a(ReadablePartial readablePartial) {
        return readablePartial.toDateTime(a).getMillis();
    }
    ...
    public static CharSequence getRelativeTimeSpanString(Context context, ReadableInstant readableInstant, int i) {
        ...
        Interval interval = z2 ? new Interval((ReadableInstant) withMillisOfSecond2, (ReadableInstant) withMillisOfSecond) : new Interval((ReadableInstant) withMillisOfSecond, (ReadableInstant) withMillisOfSecond2);
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:13:0x0063, code lost:
        if (r10.isShorterThan(r7) != false) goto L_0x0065;
     */
    ...
    public static CharSequence formatDuration(Context context, ReadableDuration readableDuration) {
        ...
        if (standardHours != 0) {
            return resources.getQuantityString(R.plurals.joda_time_android_duration_hours, standardHours, new Object[]{Integer.valueOf(standardHours)});
        }
        int standardMinutes = (int) duration.getStandardMinutes();
        if (standardMinutes != 0) {
            return resources.getQuantityString(R.plurals.joda_time_android_duration_minutes, standardMinutes, new Object[]{Integer.valueOf(standardMinutes)});
        }
        int standardSeconds = (int) duration.getStandardSeconds();
        return resources.getQuantityString(R.plurals.joda_time_android_duration_seconds, standardSeconds, new Object[]{Integer.valueOf(standardSeconds)});
    }
}
