...
final class p {
    ...
    public static synchronized String a(WeakReference<Context> weakReference) {
        ...
        synchronized (p.class) {
            ...
            if (a == null) {
                String str3 = null;
                if (weakReference.get() != null) {
                    str3 = ((Context) weakReference.get()).getSharedPreferences("appsflyer-data", 0).getString("AF_INSTALLATION", null);
                }
                if (str3 != null) {
                    a = str3;
                } else {
                ...
                if (a != null) {
                    AppsFlyerProperties.getInstance().set("uid", a);
                }
            }
            String str5 = a;
            return str5;
    ...
    private static java.lang.String a(java.io.File r5) {
        ...
        L_0x005b:
            throw r5
        */
        throw new UnsupportedOperationException("Method not decompiled: com.appsflyer.p.a(java.io.File):java.lang.String");
    }
}
