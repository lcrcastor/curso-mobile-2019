...
public final class YearMonth extends BasePartial implements Serializable, ReadablePartial {
    ...
    private static final DateTimeFieldType[] a = {DateTimeFieldType.year(), DateTimeFieldType.monthOfYear()};
    ...
    public static class Property extends AbstractPartialFieldProperty implements Serializable {
        ...
        public YearMonth addToCopy(int i) {
            return new YearMonth(this.a, getField().add(this.a, this.b, this.a.getValues(), i));
        }

        public YearMonth addWrapFieldToCopy(int i) {
            return new YearMonth(this.a, getField().addWrapField(this.a, this.b, this.a.getValues(), i));
        }

        public YearMonth setCopy(int i) {
            return new YearMonth(this.a, getField().set(this.a, this.b, this.a.getValues(), i));
        }

        public YearMonth setCopy(String str, Locale locale) {
            return new YearMonth(this.a, getField().set(this.a, this.b, this.a.getValues(), str, locale));
        }
