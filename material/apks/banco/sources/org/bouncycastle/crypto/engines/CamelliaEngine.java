...
public class CamelliaEngine implements BlockCipher {
    ...
    private int a(byte[] bArr, int i2) {
        ...
        for (int i4 = 0; i4 < 4; i4++) {
            i3 = (i3 << 8) + (bArr[i4 + i2] & UnsignedBytes.MAX_VALUE);
        }
        return i3;
    }
    ...
    private int a(byte[] bArr, int i2, byte[] bArr2, int i3) {
        for (int i4 = 0; i4 < 4; i4++) {
            this.f[i4] = a(bArr, (i4 * 4) + i2);
            int[] iArr = this.f;
            iArr[i4] = iArr[i4] ^ this.d[i4];
        }
        a(this.f, this.c, 0);
        a(this.f, this.c, 4);
        a(this.f, this.c, 8);
        ...
        a(this.f[2], bArr2, i3);
        a(this.f[3], bArr2, i3 + 4);
        a(this.f[0], bArr2, i3 + 8);
        a(this.f[1], bArr2, i3 + 12);
        return 16;
    }
    ...
    private static void a(int i2, int[] iArr, int i3, int[] iArr2, int i4) {
        int i5 = i4 + 0;
        int i6 = i3 + 0;
        int i7 = i3 + 1;
        int i8 = 32 - i2;
    ...
    private void a(int[] iArr, int[] iArr2, int i2) {
        ...
        int i4 = h[(i3 >>> 24) & 255] ^ ((i[i3 & 255] ^ k[(i3 >>> 8) & 255]) ^ j[(i3 >>> 16) & 255]);
        int i5 = iArr[1] ^ iArr2[i2 + 1];
        int i6 = (j[(i5 >>> 24) & 255] ^ ((h[i5 & 255] ^ i[(i5 >>> 8) & 255]) ^ k[(i5 >>> 16) & 255])) ^ i4;
        iArr[2] = iArr[2] ^ i6;
        iArr[3] = (a(i4, 8) ^ i6) ^ iArr[3];
        int i7 = iArr[2] ^ iArr2[i2 + 2];
        int i8 = h[(i7 >>> 24) & 255] ^ ((i[i7 & 255] ^ k[(i7 >>> 8) & 255]) ^ j[(i7 >>> 16) & 255]);
        int i9 = iArr2[i2 + 3] ^ iArr[3];
        int i10 = (j[(i9 >>> 24) & 255] ^ ((h[i9 & 255] ^ i[(i9 >>> 8) & 255]) ^ k[(i9 >>> 16) & 255])) ^ i8;
        iArr[0] = iArr[0] ^ i10;
        iArr[1] = (i10 ^ a(i8, 8)) ^ iArr[1];
    }
    ...
    private static void b(int i2, int[] iArr, int i3, int[] iArr2, int i4) {
        int i5 = i4 + 2;
        int i6 = i3 + 0;
        int i7 = i3 + 1;
        int i8 = 32 - i2;
    ...
    private void b(int[] iArr, int[] iArr2, int i2) {
        iArr[1] = iArr[1] ^ b(iArr[0] & iArr2[i2 + 0], 1);
        iArr[0] = iArr[0] ^ (iArr2[i2 + 1] | iArr[1]);
        iArr[2] = iArr[2] ^ (iArr2[i2 + 3] | iArr[3]);
        iArr[3] = b(iArr2[i2 + 2] & iArr[2], 1) ^ iArr[3];
    }

    private static void c(int i2, int[] iArr, int i3, int[] iArr2, int i4) {
        int i5 = i4 + 0;
        int i6 = i3 + 1;
        int i7 = i2 - 32;
        int i8 = i3 + 2;
    ...
    private static void d(int i2, int[] iArr, int i3, int[] iArr2, int i4) {
        int i5 = i4 + 2;
        int i6 = i3 + 1;
        int i7 = i2 - 32;
        int i8 = i3 + 2;
    ...
    public int processBlock(byte[] bArr, int i2, byte[] bArr2, int i3) {
        if (!this.a) {
            ...
            return this.b ? a(bArr, i2, bArr2, i3) : b(bArr, i2, bArr2, i3);
        } else {
