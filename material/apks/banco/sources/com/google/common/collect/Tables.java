...
public final class Tables {
    ...
    static class TransposeTable<C, R, V> extends AbstractTable<C, R, V> {
        private static final Function<Cell<?, ?, ?>, Cell<?, ?, ?>> b = new Function<Cell<?, ?, ?>, Cell<?, ?, ?>>() {
            /* renamed from: a */
    ...
    static class TransformedTable<R, C, V1, V2> extends AbstractTable<R, C, V2> {
        ...
        /* access modifiers changed from: 0000 */
        public Function<Cell<R, C, V1>, Cell<R, C, V2>> e() {
        ...
        public Map<R, Map<C, V2>> rowMap() {
            return Maps.transformValues(this.a.rowMap(), (Function<? super V1, V2>) new Function<Map<C, V1>, Map<C, V2>>() {
                /* renamed from: a */
        ...
        public Map<C, Map<R, V2>> columnMap() {
            return Maps.transformValues(this.a.columnMap(), (Function<? super V1, V2>) new Function<Map<R, V1>, Map<R, V2>>() {
                /* renamed from: a */
    ...
    static final class UnmodifiableRowSortedMap<R, C, V> extends UnmodifiableTable<R, C, V> implements RowSortedTable<R, C, V> {
        ...
        public SortedMap<R, Map<C, V>> rowMap() {
            return Collections.unmodifiableSortedMap(Maps.transformValues(delegate().rowMap(), Tables.b()));
        }
