...
public class ComprobanteContratacionPresenter extends BasePresenter<ComprobanteContratacionView> {
    private Context a;
    private String b;

    public ComprobanteContratacionPresenter(Bus bus, IDataManager iDataManager, Context context) {
        super(bus, iDataManager);
        this.a = context;
    }

    public void onCreatePage(ContratarSeguroMovilBodyResponseBean contratarSeguroMovilBodyResponseBean) {
        ((ComprobanteContratacionView) getBaseView()).setComprobanteContratacionView(contratarSeguroMovilBodyResponseBean);
    }

    public void getPoliza(String str, String str2, String str3) {
        ((ComprobanteContratacionView) getBaseView()).showProgressIndicator(VGetPoliza.nameService);
    ...
    public void onGetPoliza(GetPolizaEvent getPolizaEvent) {
        ((ComprobanteContratacionView) getBaseView()).dismissProgressIndicator();
        ...
        AnonymousClass1 r1 = new BaseWSResponseHandler(this.a, TypeOption.INTERMDIATE_VIEW, FragmentConstants.SEGUROS, getBaseView(), (BaseActivity) this.a) {
            ...
            public void onOk() {
                ComprobanteContratacionPresenter.this.a(getPolizaEvent2);
            }
        };
