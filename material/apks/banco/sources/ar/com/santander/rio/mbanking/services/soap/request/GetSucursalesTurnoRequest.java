...
public abstract class GetSucursalesTurnoRequest extends BaseRequest implements IBeanRequestWS {
    ...
    public GetSucursalesTurnoRequest(Context context, GetSucursalesRequestBean getSucursalesRequestBean, ErrorRequestServer errorRequestServer) {
        super(context);
        this.mGetSucursalesRequestBean = getSucursalesRequestBean;
        this.mErrorRequestServer = errorRequestServer;
    }

    public GetSucursalesTurnoRequest(ErrorRequestServer errorRequestServer) {
        this.mErrorRequestServer = errorRequestServer;
    }
    ...
    public boolean parserResponse(com.indra.httpclient.json.JSONObject r8) {
        ...
        L_0x0042:
            ...
            java.lang.String r5 = "listaSucursales"
        ...
        L_0x00c1:
            r3.listaSucursales = r4     // Catch:{ JSONException -> 0x003e }
        ...
        L_0x00cd:
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: ar.com.santander.rio.mbanking.services.soap.request.GetSucursalesTurnoRequest.parserResponse(com.indra.httpclient.json.JSONObject):boolean");
    }
}
