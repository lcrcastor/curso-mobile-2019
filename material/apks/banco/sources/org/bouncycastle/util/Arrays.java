...
public final class Arrays {
    ...
    public static long[] copyOfRange(long[] jArr, int i, int i2) {
        ...
        System.arraycopy(jArr, i, jArr2, 0, a);
        return jArr2;
    }

    public static BigInteger[] copyOfRange(BigInteger[] bigIntegerArr, int i, int i2) {
        int a = a(i, i2);
        BigInteger[] bigIntegerArr2 = new BigInteger[a];
        if (bigIntegerArr.length - i < a) {
            a = bigIntegerArr.length - i;
        }
        System.arraycopy(bigIntegerArr, i, bigIntegerArr2, 0, a);
        return bigIntegerArr2;
    }
