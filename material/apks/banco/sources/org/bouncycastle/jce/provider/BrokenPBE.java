...
public interface BrokenPBE {
    ...
    public static class Util {
        static CipherParameters a(BCPBEKey bCPBEKey, AlgorithmParameterSpec algorithmParameterSpec, int i, int i2, String str, int i3, int i4) {
            ...
            if (str.startsWith("DES")) {
                a((generateDerivedParameters instanceof ParametersWithIV ? (KeyParameter) ((ParametersWithIV) generateDerivedParameters).getParameters() : (KeyParameter) generateDerivedParameters).getKey());
            }
