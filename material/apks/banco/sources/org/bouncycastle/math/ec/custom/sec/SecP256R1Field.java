...
public class SecP256R1Field {
    ...
    public static void addExt(int[] iArr, int[] iArr2, int[] iArr3) {
        if (Nat.add(16, iArr, iArr2, iArr3) != 0 || ((iArr3[15] & -1) == -1 && Nat.gte(16, iArr3, b))) {
    ...
    public static void multiplyAddToExt(int[] iArr, int[] iArr2, int[] iArr3) {
        if (Nat256.mulAddTo(iArr, iArr2, iArr3) != 0 || ((iArr3[15] & -1) == -1 && Nat.gte(16, iArr3, b))) {
            Nat.subFrom(16, b, iArr3);
        }
    }
    ...
    public static void reduce(int[] iArr, int[] iArr2) {
        ...
        long j14 = j5 + j6;
        long j15 = j6 + j7;
        long j16 = ((((((long) iArr[0]) & 4294967295L) + j9) - j12) - j14) + 0;
        iArr3[0] = (int) j16;
        long j17 = j9;
        long j18 = j13;
        long j19 = (j16 >> 32) + ((((((long) iArr[1]) & 4294967295L) + j10) - j13) - j15);
        iArr3[1] = (int) j19;
        long j20 = (j19 >> 32) + (((((long) iArr[2]) & 4294967295L) + j11) - j14);
        iArr3[2] = (int) j20;
        long j21 = (j20 >> 32) + (((((((long) iArr[3]) & 4294967295L) + (j12 << 1)) + j5) - j7) - j17);
        iArr3[3] = (int) j21;
        long j22 = (j21 >> 32) + ((((((long) iArr[4]) & 4294967295L) + (j18 << 1)) + j6) - j10);
        iArr3[4] = (int) j22;
        long j23 = (j22 >> 32) + (((((long) iArr[5]) & 4294967295L) + (j14 << 1)) - j11);
        iArr3[5] = (int) j23;
        long j24 = (j23 >> 32) + ((((((long) iArr[6]) & 4294967295L) + (j15 << 1)) + j14) - j17);
        iArr3[6] = (int) j24;
        long j25 = (j24 >> 32) + (((((((long) iArr[7]) & 4294967295L) + (j7 << 1)) + j8) - j11) - j18);
        iArr3[7] = (int) j25;
    ...
    public static void reduce32(int i, int[] iArr) {
        ...
        if (i != 0) {
            ...
            iArr[6] = (int) j11;
            long j12 = (j11 >> 32) + (((long) iArr[7]) & 4294967295L) + j2;
            iArr[7] = (int) j12;
            j = j12 >> 32;
        } else {
            j = 0;
