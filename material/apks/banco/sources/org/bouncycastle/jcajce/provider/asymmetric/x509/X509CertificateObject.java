...
class X509CertificateObject extends X509Certificate implements PKCS12BagAttributeCarrier {
    ...
    private static java.util.Collection a(byte[] r5) {
        ...
        L_0x00aa:
            ...
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: org.bouncycastle.jcajce.provider.asymmetric.x509.X509CertificateObject.a(byte[]):java.util.Collection");
    }
