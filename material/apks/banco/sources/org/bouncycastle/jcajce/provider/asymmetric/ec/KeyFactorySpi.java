...
public class KeyFactorySpi extends BaseKeyFactorySpi implements AsymmetricKeyInfoConverter {
    ...
    public PrivateKey engineGeneratePrivate(KeySpec keySpec) {
        return keySpec instanceof ECPrivateKeySpec ? new BCECPrivateKey(this.a, (ECPrivateKeySpec) keySpec, this.b) : keySpec instanceof java.security.spec.ECPrivateKeySpec ? new BCECPrivateKey(this.a, (java.security.spec.ECPrivateKeySpec) keySpec, this.b) : super.engineGeneratePrivate(keySpec);
    }

    /* access modifiers changed from: protected */
    public PublicKey engineGeneratePublic(KeySpec keySpec) {
        return keySpec instanceof ECPublicKeySpec ? new BCECPublicKey(this.a, (ECPublicKeySpec) keySpec, this.b) : keySpec instanceof java.security.spec.ECPublicKeySpec ? new BCECPublicKey(this.a, (java.security.spec.ECPublicKeySpec) keySpec, this.b) : super.engineGeneratePublic(keySpec);
    }
