...
public class EncryptedData extends ASN1Object {
    ...
    private EncryptedData(ASN1Sequence aSN1Sequence) {
        ...
        this.a = ASN1Sequence.getInstance(aSN1Sequence.getObjectAt(1));
    }
    ...
    public ASN1OctetString getContent() {
        if (this.a.size() == 3) {
            return ASN1OctetString.getInstance(ASN1TaggedObject.getInstance(this.a.getObjectAt(2)), false);
        }
        return null;
    }

    public ASN1ObjectIdentifier getContentType() {
        return ASN1ObjectIdentifier.getInstance(this.a.getObjectAt(0));
    }

    public AlgorithmIdentifier getEncryptionAlgorithm() {
        return AlgorithmIdentifier.getInstance(this.a.getObjectAt(1));
    }
