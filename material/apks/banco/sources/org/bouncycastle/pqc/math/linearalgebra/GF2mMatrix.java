...
public class GF2mMatrix extends Matrix {
    ...
    public GF2mMatrix(GF2mField gF2mField, byte[] bArr) {
        ...
        this.numRows = ((((bArr[3] & UnsignedBytes.MAX_VALUE) << Ascii.CAN) ^ ((bArr[2] & UnsignedBytes.MAX_VALUE) << Ascii.DLE)) ^ ((bArr[1] & UnsignedBytes.MAX_VALUE) << 8)) ^ (bArr[0] & UnsignedBytes.MAX_VALUE);
                ...
                while (i5 < this.numRows) {
                    ...
                    while (i7 < this.numColumns) {
                        ...
                        while (i9 < i) {
                            ...
                            int i10 = i8 + 1;
                            iArr[i7] = ((bArr[i8] & UnsignedBytes.MAX_VALUE) << i9) ^ iArr[i7];
                            i9 += 8;
                            i8 = i10;
                        }
