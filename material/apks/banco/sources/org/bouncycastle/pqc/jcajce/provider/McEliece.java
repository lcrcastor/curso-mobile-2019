...
public class McEliece {
    ...
    public static class Mappings extends AsymmetricAlgorithmProvider {
        public void configure(ConfigurableProvider configurableProvider) {
            ...
            sb.append(PQCObjectIdentifiers.mcEliece);
            configurableProvider.addAlgorithm(sb.toString(), "org.bouncycastle.pqc.jcajce.provider.mceliece.McElieceKeyPairGeneratorSpi$McEliece");
            StringBuilder sb2 = new StringBuilder();
            sb2.append("KeyPairGenerator.");
            sb2.append(PQCObjectIdentifiers.mcElieceCca2);
            configurableProvider.addAlgorithm(sb2.toString(), "org.bouncycastle.pqc.jcajce.provider.mceliece.McElieceKeyPairGeneratorSpi$McElieceCCA2");
