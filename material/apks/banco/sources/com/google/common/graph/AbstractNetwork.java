...
public abstract class AbstractNetwork<N, E> implements Network<N, E> {
    ...
    public String toString() {
        return String.format("%s, nodes: %s, edges: %s", new Object[]{String.format("isDirected: %s, allowsParallelEdges: %s, allowsSelfLoops: %s", new Object[]{Boolean.valueOf(isDirected()), Boolean.valueOf(allowsParallelEdges()), Boolean.valueOf(allowsSelfLoops())}), nodes(), a()});
    }

    private Map<E, EndpointPair<N>> a() {
