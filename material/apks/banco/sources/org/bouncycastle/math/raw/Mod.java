...
public abstract class Mod {
    ...
    public static void invert(int[] iArr, int[] iArr2, int[] iArr3) {
        ...
        if (Nat.isZero(length, iArr2)) {
            ...
            create[0] = 1;
            int a = (1 & copy[0]) == 0 ? a(iArr, copy, length, create, 0) : 0;
            if (Nat.isOne(length, copy)) {
                a(iArr, a, create, iArr3);
                return;
            }
            ...
            while (true) {
                ...
                if (copy[i3] == 0 && copy2[i3] == 0) {
                    ...
                    a = a(iArr, copy, i, create, a + (Nat.subFrom(length, create2, create) - i2));
                    if (Nat.isOne(i, copy)) {
                        a(iArr, a, create, iArr3);
                        return;
                    }
                    ...
                    i2 = a(iArr, copy2, i, create2, i2 + (Nat.subFrom(length, create, create2) - a));
                    if (Nat.isOne(i, copy2)) {
                        a(iArr, i2, create2, iArr3);
                        return;
                    }
                }
            }
