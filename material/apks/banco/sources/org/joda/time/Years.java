...
public final class Years extends BaseSingleFieldPeriod {
    public static final Years MAX_VALUE = new Years(SubsamplingScaleImageView.TILE_SIZE_AUTO);
    public static final Years MIN_VALUE = new Years(Integer.MIN_VALUE);
    public static final Years ONE = new Years(1);
    public static final Years THREE = new Years(3);
    public static final Years TWO = new Years(2);
    public static final Years ZERO = new Years(0);
    private static final PeriodFormatter a = ISOPeriodFormat.standard().withParseType(PeriodType.years());
    ...
    public static Years parseYears(String str) {
        ...
        return years(a.parsePeriod(str).getYears());
    }
