...
class CheckForUpdatesRequest extends AbstractSpiCall {
    private final CheckForUpdatesResponseTransform a;
    ...
    public CheckForUpdatesRequest(Kit kit, String str, String str2, HttpRequestFactory httpRequestFactory, CheckForUpdatesResponseTransform checkForUpdatesResponseTransform) {
        ...
        this.a = checkForUpdatesResponseTransform;
    }
    ...
    public com.crashlytics.android.beta.CheckForUpdatesResponse a(java.lang.String r5, java.lang.String r6, com.crashlytics.android.beta.BuildProperties r7) {
        /*
            r4 = this;
            r0 = 0
            java.util.Map r7 = r4.a(r7)     // Catch:{ Exception -> 0x00c5, all -> 0x00c2 }
            io.fabric.sdk.android.services.network.HttpRequest r1 = r4.getHttpRequest(r7)     // Catch:{ Exception -> 0x00c5, all -> 0x00c2 }
            io.fabric.sdk.android.services.network.HttpRequest r5 = r4.a(r1, r5, r6)     // Catch:{ Exception -> 0x00bf, all -> 0x00bc }
            ...
            com.crashlytics.android.beta.CheckForUpdatesResponseTransform r7 = r4.a     // Catch:{ Exception -> 0x00ba }
            com.crashlytics.android.beta.CheckForUpdatesResponse r6 = r7.a(r6)     // Catch:{ Exception -> 0x00ba }
        ...
        L_0x012b:
            throw r6
        */
        throw new UnsupportedOperationException("Method not decompiled: com.crashlytics.android.beta.CheckForUpdatesRequest.a(java.lang.String, java.lang.String, com.crashlytics.android.beta.BuildProperties):com.crashlytics.android.beta.CheckForUpdatesResponse");
    }
