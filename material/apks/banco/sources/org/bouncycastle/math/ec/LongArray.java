...
class LongArray {
        ...
        if (bigInteger == null || bigInteger.signum() < 0) {
            ...
            while (i2 >= 0) {
                ...
                while (i7 < 8) {
                    i7++;
                    i6++;
                    j2 = (j2 << 8) | ((long) (byteArray[i6] & UnsignedBytes.MAX_VALUE));
                }
                this.g[i2] = j2;
                i2--;
                i = i6;
    ...
    private static int a(long r3) {
        ...
        L_0x002e:
            ...
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: org.bouncycastle.math.ec.LongArray.a(long):int");
    }
    ...
    private static void a(long j, long[] jArr, int i, long[] jArr2, int i2) {
        ...
        while (true) {
            ...
            if (j3 != 0) {
                if ((j3 & 1) != 0) {
                    long b2 = b(jArr4, i4, jArr3, 0, i3, i5);
                    if (b2 != 0) {
                        int i6 = i4 + i3;
                        jArr4[i6] = jArr4[i6] ^ b2;
                    }
                }
                i5++;
                j2 = j3;
    ...
    private void a(LongArray longArray, int i, int i2) {
        ...
        long b2 = b(this.g, i4, longArray.g, 0, i3, i5);
        if (b2 != 0) {
            long[] jArr = this.g;
            int i6 = i3 + i4;
            jArr[i6] = jArr[i6] ^ b2;
    ...
    private static int b(long[] jArr, int i, int i2, int i3, int[] iArr) {
        ...
        if (min > max) {
            a(jArr2, i4, i10, max, i6, iArr2);
        } else {
            max = min;
        }
        if (max > i6) {
            c(jArr2, i4, max, i6, iArr2);
        }
        return i7;
    }
    ...
    private static void b(long[] jArr, int i, int i2, int i3, int i4, int[] iArr) {
        ...
        while (true) {
            length--;
            if (length >= 0) {
                d(jArr, i, jArr, i + i3, i2 - i3, i5 + iArr[length]);
            } else {
    ...
    private static void b(long[] jArr, int i, long[] jArr2, int i2, long[] jArr3, int i3, int i4) {
        ...
        for (int i6 = 0; i6 < i5; i6++) {
            int i7 = i + i6;
            jArr[i7] = jArr[i7] ^ (jArr2[i2 + i6] ^ jArr3[i3 + i6]);
        }
    }
    ...
    private static long d(int i) {
        int i2 = b[i & 255] | (b[(i >>> 8) & 255] << 16);
        return ((((long) ((b[i >>> 24] << 16) | b[(i >>> 16) & 255])) & 4294967295L) << 32) | (((long) i2) & 4294967295L);
    }
    ...
    private static void d(long[] jArr, int i, long[] jArr2, int i2, int i3, int i4) {
        ...
        jArr[i5] = jArr[i5] ^ c(jArr, i5 + 1, jArr2, i2, i3, 64 - i6);
    }
    ...
    public LongArray a(int i, int i2, int[] iArr) {
        int c2 = c();
        if (c2 == 0) {
            return this;
        }
        long[] jArr = new long[(((i2 + 63) >>> 6) << 1)];
        System.arraycopy(this.g, 0, jArr, 0, c2);
        while (true) {
            i--;
            if (i < 0) {
                return new LongArray(jArr, 0, c2);
            }
            a(jArr, c2, i2, iArr);
            c2 = b(jArr, 0, jArr.length, i2, iArr);
        }
    }
    ...
    public LongArray a(LongArray longArray, int i, int[] iArr) {
        ...
        int i6 = ((d2 + d3) + 62) >>> 6;
        if (i4 == 1) {
            long j = longArray3.g[0];
            if (j == 1) {
                return longArray2;
            }
            long[] jArr2 = new long[i6];
            a(j, longArray2.g, i5, jArr2, 0);
            return a(jArr2, 0, i6, i2, iArr2);
        }
        int i7 = ((d3 + 7) + 63) >>> 6;
        int[] iArr3 = new int[16];
        long[] jArr3 = new long[(i7 << 4)];
        iArr3[1] = i7;
        System.arraycopy(longArray2.g, 0, jArr3, i7, i5);
        int i8 = 2;
        int i9 = i7;
        while (i8 < 16) {
            i9 += i7;
            ...
            if ((i8 & 1) == 0) {
                jArr = jArr3;
                a(jArr3, i9 >>> 1, jArr3, i9, i7, 1);
            } else {
                jArr = jArr3;
                a(jArr, i7, jArr3, i9 - i7, jArr, i9, i7);
            }
            i8++;
            jArr3 = jArr;
        }
        ...
        a(jArr4, 0, jArr5, 0, jArr4.length, 4);
        long[] jArr6 = longArray3.g;
        ...
        for (int i10 = 0; i10 < i4; i10++) {
            ...
            while (true) {
                ...
                int i12 = ((int) j3) & 15;
                long j4 = j3;
                b(jArr7, i11, jArr4, iArr3[((int) j2) & 15], jArr5, iArr3[i12], i7);
                j2 = j4 >>> 4;
                if (j2 == 0) {
                    break;
                }
        ...
        while (true) {
            length -= i6;
            if (length == 0) {
                return a(jArr7, 0, i6, i2, iArr2);
            }
            b(jArr7, length - i6, jArr7, length, i6, 8);
        }
    }

    public void a(int i, int[] iArr) {
        long[] jArr = this.g;
        int b2 = b(jArr, 0, jArr.length, i, iArr);
        if (b2 < jArr.length) {
            this.g = new long[b2];
            System.arraycopy(jArr, 0, this.g, 0, b2);
        }
    }
    ...
    public LongArray b(int i, int[] iArr) {
        ...
        return new LongArray(jArr, 0, b(jArr, 0, jArr.length, i, iArr));
    }

    public LongArray b(LongArray longArray, int i, int[] iArr) {
        LongArray longArray2;
        LongArray longArray3;
        long[] jArr;
        int d2 = d();
        ...
        iArr2[1] = i6;
        System.arraycopy(longArray2.g, 0, jArr3, i6, i4);
        int i7 = 2;
        int i8 = i6;
        while (i7 < 16) {
            i8 += i6;
            ...
            if ((i7 & 1) == 0) {
                jArr = jArr3;
                a(jArr3, i8 >>> 1, jArr3, i8, i6, 1);
            } else {
                jArr = jArr3;
                a(jArr, i6, jArr, i8 - i6, jArr3, i8, i6);
            }
            i7++;
            jArr3 = jArr;
        }
        ...
        for (int i9 = 0; i9 < i3; i9++) {
            ...
            while (true) {
                ...
                int i11 = ((int) j3) & 15;
                long j4 = j3;
                b(jArr7, i10, jArr4, iArr2[((int) j2) & 15], jArr5, iArr2[i11], i6);
                j2 = j4 >>> 4;
                if (j2 == 0) {
                    break;
                }
        ...
        while (true) {
            ...
            b(jArr7, length - i5, jArr7, length, i5, 8);
        }
    }
    ...
    public LongArray c(int i, int[] iArr) {
        int c2 = c();
        if (c2 == 0) {
            return this;
        }
    ...
    public Object clone() {
        return new LongArray(Arrays.clone(this.g));
    }
    ...
    public LongArray d(int i, int[] iArr) {
        int d2 = d();
        if (d2 == 0) {
            ...
            while (true) {
                ...
                int i8 = 1 - i7;
                longArrayArr[i7].a(longArrayArr[i8], iArr2[i8], i4);
                int b2 = longArrayArr[i7].b(i6);
                if (b2 == 0) {
                    return longArrayArr2[i8];
                }
                int i9 = iArr3[i8];
                longArrayArr2[i7].a(longArrayArr2[i8], i9, i4);
                int i10 = i9 + i4;
                if (i10 > i5) {
                    i5 = i10;
                } else if (i10 == i5) {
                    i5 = longArrayArr2[i7].b(i5);
                }
                i4 += b2 - i6;
                i6 = b2;
            }
    ...
    public LongArray f() {
        ...
        long[] c2 = c(Math.max(1, c()));
        c2[0] = c2[0] ^ 1;
        return new LongArray(c2);
    }
